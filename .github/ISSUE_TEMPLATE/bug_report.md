...
<!--
Thank you for reporting a possible bug in WP-Author-Migration.
...
The version of this plugin can be found by clicking "Plugins" in the Admin navigation and finding "WP Author Migration" in the list of plugins. The version number will be listed under the plugin description.
-->
